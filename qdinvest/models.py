...
class STOCK(models.Model):
	...
	st_total_price = models.DecimalField(max_digits=16,decimal_places=2,verbose_name='投资总额')
	st_current_price = models.DecimalField(max_digits=16,decimal_places=2,verbose_name='当前已经认购')
	st_min_price = models.DecimalField(max_digits=16,decimal_places=2,verbose_name='认购起点')
...
class BOND(models.Model):
	...
	bo_total_price = models.DecimalField(max_digits=16,decimal_places=2,verbose_name='融资总额')
	bo_current_price = models.DecimalField(max_digits=16,decimal_places=2,verbose_name='当前已经认购')
	bo_min_price = models.DecimalField(max_digits=16,decimal_places=2,verbose_name='认购起点')
